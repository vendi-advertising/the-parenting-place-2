...
if ( ! function_exists( 'the_parenting_place_2018_setup' ) ) :
	...
	function the_parenting_place_2018_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'the_parenting_place_2018_custom_background_args', array(
...
add_action( 'after_setup_theme', 'the_parenting_place_2018_setup' );
...
function the_parenting_place_2018_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'the_parenting_place_2018_content_width', 640 );
}
add_action( 'after_setup_theme', 'the_parenting_place_2018_content_width', 0 );
...
function the_parenting_place_2018_scripts() {
	...
	wp_enqueue_script( 'the-parenting-place-2018-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
