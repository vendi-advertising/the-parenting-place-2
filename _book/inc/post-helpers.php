...
if ( ! function_exists( 'the_parenting_place_2018_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
function the_parenting_place_2018_posted_on() {
...
if ( ! function_exists( 'the_parenting_place_2018_entry_footer' ) ) :
/**
 * Prints HTML with meta information for the categories, tags and comments.
 */
function the_parenting_place_2018_entry_footer() {
...
function the_parenting_place_2018_categorized_blog() {
	...
	if ( $all_the_cool_cats > 1 ) {
		...
		// This blog has only 1 category so the_parenting_place_2018_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in the_parenting_place_2018_categorized_blog.
 */
function the_parenting_place_2018_category_transient_flusher() {
	if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) {
		return;
	}
	// Like, beat it. Dig?
	delete_transient( 'the_parenting_place_2018_categories' );
}
add_action( 'edit_category', 'the_parenting_place_2018_category_transient_flusher' );
add_action( 'save_post',     'the_parenting_place_2018_category_transient_flusher' );


if ( ! function_exists( 'the_parenting_place_2018_comment' ) ) :
    /**
     * Template for comments and pingbacks.
     *
     * Used as a callback by wp_list_comments() for displaying the comments.
     */
    function the_parenting_place_2018_comment( $comment, $args, $depth ) {
...
endif; // ends check for the_parenting_place_2018_comment()